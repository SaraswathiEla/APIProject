...
public class AddProjectRmgUI_andverifyinDatabase{
		...
		while(result.next())
			{
				...
				if(projectId.equals("101"))
				{
				
			 		System.out.println(projectId+" sucessfully created in database");
			 		break;
				}
				
				if(projectName.equals("TY_PROJ_78"))
				{
				
			 		System.out.println(projectName+" sucessfully created in database");
			 		break;
				}
